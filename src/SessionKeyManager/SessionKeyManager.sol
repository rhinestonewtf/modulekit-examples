...
contract SessionKeyManager is ValidatorBase {
    ...
    event NewRoot(address account, bytes root);
    ...
    function setMerkleRoot(bytes32 _merkleRoot) external {
        ...
        emit NewRoot(msg.sender, abi.encodePacked(_merkleRoot));
    }
     ...
     */
    function isValidSignature(bytes32 _dataHash, bytes memory _signature) public pure override returns (bytes4) {
